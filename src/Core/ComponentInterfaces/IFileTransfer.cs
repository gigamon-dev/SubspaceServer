...
namespace SS.Core.ComponentInterfaces
{
    ...
    public interface IFileTransfer : IComponentInterface
    {
        ...
        /// <param name="p">The player to request a file from.</param>
        /// <param name="path">The path and file name.</param>
        /// <param name="uploaded">
        ...
        /// </returns>
        bool RequestFile<T>(Player p, string path, FileUploadedDelegate<T> uploaded, T arg);
        ...
        /// </summary>
        /// <param name="p">The player to get the working directory for.</param>
