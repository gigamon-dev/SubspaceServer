...
{
    /// <summary>
    /// Callback delegate for when a flag is placed on the map in a carry flag game.
    /// </summary>
    ...
    [ComponentCallback]
    public delegate void FlagOnMapCallback(Arena arena, short flagId, TileCoordinates coordinates, short freq);
}
