...
{
    /// <summary>
    /// Callback delegate for when a <see cref="Player"/> kills another <see cref="Player"/>.
    /// </summary>
    ...
    [ComponentCallback]
    public delegate void KillCallback(Arena arena, Player killer, Player killed, short bounty, short flagCount, short points, Prize green);
}
