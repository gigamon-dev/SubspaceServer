...
namespace SS.Core.ComponentCallbacks
{
    ...
    /// <summary>
    /// Callback delegate for when a player spawns.
    /// </summary>
    ...
    /// </param>
    [ComponentCallback]
    public delegate void PlayerSpawnCallback(Player player, PlayerSpawnReason reason);
}
