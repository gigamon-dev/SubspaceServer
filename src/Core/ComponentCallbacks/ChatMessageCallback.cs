...
{
    /// <summary>
    /// Callback delegate for when a chat message is sent.
    /// </summary>
    ...
    [ComponentCallback]
    public delegate void ChatMessageCallback(Arena? arena, Player? player, ChatMessageType type, ChatSound sound, Player? toPlayer, short freq, ReadOnlySpan<char> message);
}
